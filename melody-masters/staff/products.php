...
<div class="dashboard-layout">
        ...
        <div class="dashboard-content" style="padding: 2.5rem;">
            ...
            <?php else: ?>
                <div class="dashboard-header" style="justify-content: space-between;">
                    <div>
                        <h1 style="font-size: 1.5rem; margin-bottom: 0.5rem;">Inventory Status</h1>
                        <p style="color: var(--text-muted); margin: 0;">Perform stock adjustments and manage products</p>
                    </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <?php foreach($products as $p): ?>
                                <tr style="<?php echo (!$p['is_digital'] && $p['stock'] < 5) ? 'background: rgba(239, 68, 68, 0.05);' : ''; ?>">
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 1rem;">
                                            ...
                                            <?php if($p['is_digital']): ?>
                                                <span class="badge badge-primary" style="margin-left:auto;"><i class="ph ph-download-simple"></i> Digital</span>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <form action="" method="POST" style="display: flex; gap: 0.5rem; align-items: center; width: 150px;">
                                                <input type="hidden" name="product_id" value="<?php echo $p['id']; ?>">
                                                <input type="number" name="stock" class="form-control" value="<?php echo $p['stock']; ?>" min="0" style="width: 80px; padding: 0.25rem 0.5rem; height: auto;">
                                                <button type="submit" name="update_stock" class="btn btn-secondary" style="padding: 0.35rem 0.65rem;" title="Save Stock"><i class="ph ph-floppy-disk"></i></button>
                                            </form>
                                        <?php endif; ?>
                                    </td>
